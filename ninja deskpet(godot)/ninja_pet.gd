...
func show_study_plan():
	...
	# 显示计划文本
	var plan_text = "📋 Your 48-Hour Final Exam Battle Plan:\n\n"
	plan_text += "📅 Day 1:\n"
	plan_text += "• 9:00-11:00 - 🔥 Attack your weakest topic (Dynamic Programming)\n"
	plan_text += "• 11:15-12:45 - 💪 Solve practice problems on this topic\n"
	plan_text += "• 13:30-15:30 - 📚 Review second hardest topic\n"
	plan_text += "• 15:45-17:45 - 📝 Create summary notes\n"
	plan_text += "• 19:00-20:30 - ✅ Quick review and self-test\n\n"
	
	plan_text += "📅 Day 2:\n"
	plan_text += "• 9:00-11:00 - 📊 Full practice exam\n"
	plan_text += "• 11:15-13:15 - 🔍 Review mistake areas\n"
	plan_text += "• 14:00-16:00 - 📖 Final review of all topics\n"
	plan_text += "• 16:15-17:45 - 🧠 Flash card review\n"
	plan_text += "• 19:00-20:00 - 🧘 Relaxation and mental preparation\n\n"
	
	plan_text += "💡 Remember: Take 5-minute breaks every 25 minutes, and longer 15-minute breaks every 2 hours!\n\n"
...
func show_practice_test():
	...
	test_text += "1️⃣ What is the time complexity of QuickSort in the worst case?\n"
	test_text += "   a) O(n log n)\n"
	test_text += "   b) O(n²)\n"
	test_text += "   c) O(n)\n\n"
	
	test_text += "2️⃣ Dynamic Programming is based on which principle?\n"
	test_text += "   a) Divide and conquer\n"
	test_text += "   b) Greedy approach\n"
	test_text += "   c) Optimal substructure\n\n"
	
	test_text += "3️⃣ Which data structure is most efficient for implementing priority queue?\n"
	test_text += "   a) Array\n"
	test_text += "   b) Heap\n"
	test_text += "   c) Linked List\n\n"
	
	test_text += "✍️ Type your answers as '1b 2c 3a' format."
